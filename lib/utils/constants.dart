...
class AppConstants {
  ...
  static const String baseUrl =
      'http://10.0.2.2:3000/api'; // URL base da API REST

  static const String dbName = 'pint2526.db'; //base de dados local (SQlite)
  static const int dbVersion =
      1; //versão da db -> compara e gatante que o user tem a versão atual da db caso a altere

  //chaves do SharedPreferences (tipo "cockies" com informações do consultor)
